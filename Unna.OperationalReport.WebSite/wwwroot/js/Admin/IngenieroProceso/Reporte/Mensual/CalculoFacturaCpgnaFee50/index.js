...
function Obtener() {
    ...
    $("#tblTipoCambioVisualizador tbody").html("");
...
function RespuestaObtener(data) {
    ...
    $("#tbCm").val(data.cm);
    $("#tbCm2").val(data.cm);
    $("#tbPrecioFacturacion").val(data.precioFacturacion);
    $("#tbPSec").val(data.pSec);
    $("#tbVtotal").val(data.vtotal);

    $("#tbCmPrecioPsec").val(data.cmPrecioPsec);
    $("#tbIgvCmEep").val(data.igvCmEep);
    $("#tbMontoTotalCmEep").val(data.montoTotalCmEep);

    $("#tbImporteCmEep").val(data.importeCmEep);
    $("#tbPrecioSecado").val(data.precioSecado);
    $("#tbIgv").val(data.igv);
    $("#tbTotal").val(data.total);

    if (data.precioGlp != null) {
        pintarPeriodoPrecio(data.precioGlp);;
    }
