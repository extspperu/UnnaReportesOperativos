...
using Unna.OperationalReport.Service.Reportes.ReporteMensual.ResBalanceEnergLIV.Dtos;
using Unna.OperationalReport.Service.Reportes.ReporteMensual.ResBalanceEnergLIV.Servicios.Abstracciones;
...
namespace Unna.OperationalReport.Service.Reportes.ReporteMensual.ResBalanceEnergLIV.Servicios.Implementaciones
{
    public class ResBalanceEnergLIVServicio : IResBalanceEnergLIVServicio
    {
        ...
        public async Task<OperacionDto<ResBalanceEnergLIVDto>> ObtenerAsync(long idUsuario)
        {
            ...
            else
            {
                ...
                JsonObjDto jsonObjDto = JsonConvert.DeserializeObject<JsonObjDto>(jsonData);
                ...
                if (jsonObjDto != null)
                {
                    ...
                    dto.DensidadGLPKgBl = jsonObjDto.ParametrosLGN.DensidadGLPKgBl;
                    dto.PCGLPMMBtuBl60F = jsonObjDto.ParametrosLGN.PCGLPMMBtuBl60F;
                    dto.PCCGNMMBtuBl60F = jsonObjDto.ParametrosLGN.PCCGNMMBtuBl60F;
                    dto.PCLGNMMBtuBl60F = jsonObjDto.ParametrosLGN.PCLGNMMBtuBl60F;
                    dto.FactorConversionSCFDGal = jsonObjDto.ParametrosLGN.FactorConversionSCFDGal;

                    dto.EnergiaMMBTUQ1GLP = jsonObjDto.ParametrosLGN.EnergiaMMBTUQ1GLP;
                    dto.EnergiaMMBTUQ1CGN = jsonObjDto.ParametrosLGN.EnergiaMMBTUQ1CGN;

                    dto.DensidadGLPKgBlQ2 = jsonObjDto.ParametrosLGN.DensidadGLPKgBlQ2;
                    dto.PCGLPMMBtuBl60FQ2 = jsonObjDto.ParametrosLGN.PCGLPMMBtuBl60FQ2;
                    dto.PCCGNMMBtuBl60FQ2 = jsonObjDto.ParametrosLGN.PCCGNMMBtuBl60FQ2;
                    dto.PCLGNMMBtuBl60FQ2 = jsonObjDto.ParametrosLGN.PCLGNMMBtuBl60FQ2;
                    dto.FactorConversionSCFDGalQ2 = jsonObjDto.ParametrosLGN.FactorConversionSCFDGalQ2;

                    dto.EnergiaMMBTUQ2GLP = jsonObjDto.ParametrosLGN.EnergiaMMBTUQ2GLP;
                    dto.EnergiaMMBTUQ2CGN = jsonObjDto.ParametrosLGN.EnergiaMMBTUQ2CGN;


                    dto.ResBalanceEnergLIVDetMedGas = jsonObjDto.DatosDiarios
                    ...
                    dto.GNSEnergia1Q = jsonObjDto.ResumenGNSEnergia.GNSEnergia1Q;
                    dto.GNSEnergia2Q = jsonObjDto.ResumenGNSEnergia.GNSEnergia2Q;

                    try
                    {
                        foreach (var diaMedicion in jsonObjDto.DatosDiarios)
                        {
                    ...
                    dto.ResBalanceEnergLIVDetGnaFisc = jsonObjDto.DatosDiarios
                        .SelectMany(d => d.Mediciones
                    ...
                    dto.ResBalanceEnergLgnLIV_2DetLgnDto = jsonObjDto.DatosDiarios
                        .SelectMany(d => d.Mediciones
            ...
            foreach (var day in allDaysInMonth)
            {
                ...
                else
                {
                    ResBalanceEnergLgnLIV_2DetLgn.Add(new ResBalanceEnergLgnLIV_2DetLgnDto
                    {
                        ...
                        MedGasGlpPoderCal = parametro != null ? Math.Round(Convert.ToDouble(parametro.PCGLPMMBtuBl60F), 4) : (double?)null,
                        MedGasGlpEnergia = Math.Round(0.0 * (parametro != null ? Convert.ToDouble(parametro.PCGLPMMBtuBl60F) : 0), 4), 
                        MedGasGlpDensidad = parametro != null ? Math.Round(Convert.ToDouble(parametro.DensidadGLPKgBl), 4) : (double?)null,

                        MedGasCgnVolumen = Math.Round(0.0, 4),
                        MedGasCgnPoderCal = parametro != null ? Math.Round(Convert.ToDouble(parametro.PCCGNMMBtuBl60F), 4) : (double?)null,
                        MedGasCgnEnergia = Math.Round(0.0 * (parametro != null ? Convert.ToDouble(parametro.PCCGNMMBtuBl60F) : 0), 4), 

                        MedGasLgnVolumen = Math.Round(0.0, 4),
                        MedGasLgnPoderCal = parametro != null ? Math.Round(Convert.ToDouble(parametro.PCLGNMMBtuBl60F), 4) : (double?)null,
                        MedGasLgnEnergia = Math.Round(0.0 * (parametro != null ? Convert.ToDouble(parametro.PCLGNMMBtuBl60F) : 0), 4), 
                    });
                }
            }
        ...
        public async Task<OperacionDto<RespuestaSimpleDto<string>>> GuardarAsync(JsonObjDto peticion)
        {
