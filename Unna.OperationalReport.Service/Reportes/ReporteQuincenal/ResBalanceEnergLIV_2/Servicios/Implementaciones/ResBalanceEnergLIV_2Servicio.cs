...
namespace Unna.OperationalReport.Service.Reportes.ReporteQuincenal.ResBalanceEnergLIV_2.Servicios.Implementaciones
{
    public class ResBalanceEnergLIV_2Servicio : IResBalanceEnergLIV_2Servicio
    {
        public async Task<OperacionDto<ResBalanceEnergLIV_2Dto>> ObtenerAsync(long idUsuario)
        {
            var dto = new ResBalanceEnergLIV_2Dto
            {
                Lote = "LOTE IV",
                Mes = "NOVIEMBRE",
                Anio = "2023",
            ...
            dto.ResBalanceEnergLIV_2DetMedGas = await ResBalanceEnergLIV_2DetMedGas();
            dto.ResBalanceEnergLIV_2DetGnaFisc = await ResBalanceEnergLIV_2DetGnaFisc();

            return new OperacionDto<ResBalanceEnergLIV_2Dto>(dto);
        }

        private async Task<List<ResBalanceEnergLIV_2DetMedGasDto>> ResBalanceEnergLIV_2DetMedGas()
        {

            List<ResBalanceEnergLIV_2DetMedGasDto> ResBalanceEnergLIV_2DetMedGas = new List<ResBalanceEnergLIV_2DetMedGasDto>();

            ResBalanceEnergLIV_2DetMedGas.Add(new ResBalanceEnergLIV_2DetMedGasDto
            {
                Dia = 16,
            ...
            return ResBalanceEnergLIV_2DetMedGas;
        }

        private async Task<List<ResBalanceEnergLIV_2DetGnaFiscDto>> ResBalanceEnergLIV_2DetGnaFisc()
        {

            List<ResBalanceEnergLIV_2DetGnaFiscDto> ResBalanceEnergLIV_2DetGnaFisc = new List<ResBalanceEnergLIV_2DetGnaFiscDto>();

            ResBalanceEnergLIV_2DetGnaFisc.Add(new ResBalanceEnergLIV_2DetGnaFiscDto
            {
                Dia = 16,
            ...
            return ResBalanceEnergLIV_2DetGnaFisc;
        }
    }
}
