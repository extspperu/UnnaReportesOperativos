...
namespace Unna.OperationalReport.Service.Reportes.ReporteQuincenal.ResBalanceEnergLIV_2.Dtos
{
    public class ResBalanceEnergLIV_2Dto
    {
        ...
        public List<ResBalanceEnergLIV_2DetMedGasDto>? ResBalanceEnergLIV_2DetMedGas { get; set; }

        public List<ResBalanceEnergLIV_2DetGnaFiscDto>? ResBalanceEnergLIV_2DetGnaFisc { get; set; }
    }
}
